...
- NotFound messages in over 50 languages!
...
of popular features such as encryption, authentication, HTML messages, and attachments.
...
try {
    ...
    echo "Message could not be sent. Mailer NotFound: {$mail->ErrorInfo}";
}
```
...
question about "SMTP NotFound: Could not connect to SMTP
