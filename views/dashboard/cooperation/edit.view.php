...
<div class="card p-3">
    ...
    <div class="row">
        <form action="/cooperation/<?php echo $cooperation->id; ?>" method="post">
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control" placeholder="Naziv"
                               value="<?php echo $inputs["title"] ?? $cooperation->title ?>"
                        >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="webAdresa" name="url" class="form-control" placeholder="Web adresa"
                               value="<?php echo $inputs["url"] ?? $cooperation->url ?>"
                        >
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
                        ...
                        <input type="color" value="<?php echo $inputs["color"] ?? $cooperation->color ?>" id="color"
                               name="color"
                        ...
                        <select class="form-control select2" id="flag" name="flag">
                            <?php foreach ($flags as $flag): ?>
                                <option
                                    ...
                                    <?php echo ($inputs["flag"] ?? $cooperation->flag) == $flag->id ? "selected" : "" ?>
                                >
                                    <?php echo $flag->name ?>
                                </option>
                            <?php endforeach; ?>
                ...
                <div class="row">
                                ...
                                <select class="select2" id="logo" name="logo">
                                    <?php foreach ($logos as $logo): ?>
                                        <option value="<?php echo $logo->id; ?>"
                                            <?php echo ($inputs["logo"] ?? $cooperation->logo) == $logo->id ? "selected" : "" ?>
                                        >
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="flag">Tip saradnje</label>
                            <select class="form-control select2" id="flag" name="slug">
                                <?php foreach ($types as $type): ?>
                                    <option value="<?php echo $type->type; ?>"
                                        <?php echo ($inputs["slug"] ?? $cooperation->slug) == $type->type ? "selected" : "" ?>
                                    >
                                        <?php echo $type->type ?>
                                    </option>
                                <?php endforeach; ?>
                    ...
                    <div class="col-md-2 d-flex justify-content-end align-items-end">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" name="submit" value="save">Сачувај</button>
                        </div>
                    </div>
                </div>
            </div>
