    ...
    <div class="d-flex justify-content-between align-content-center">
        ...
        <div class="d-flex gap-2">
            <a class="btn btn-primary d-flex justify-content-center align-items-center"
               href="/admission/create?lang=srb">
                <i class="mdi mdi-plus-box font-24 lh-1"></i>SRB</a>
            <a class="btn btn-primary d-flex justify-content-center align-items-center"
               href="/admission/create?lang=en">
                        ...
                        <?php foreach ($uslovi[$nivo->id] as $uslov): ?>
                            <div class="accordion-item mb-1">
                                <div class="accordion-header alert alert-dark m-0 border-1 p-1 d-flex gap-1 align-items-center justify-content-between">
                                    <form action="admission/requirement/priority/<?php echo $uslov->id; ?>" class="d-flex" method="post">
                                        <input type="hidden" name="_method" value="patch">
                                        <input name="prioritet" class="form-control p-1" style="width: 45px" type="number" value="<?php echo $uslov->prioritet; ?>">
                                ...
                                <div id="flush-collapse-<?php echo $uslov->id; ?>"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="accordion_footer alert alert-dark p-1 d-flex gap-1 justify-content-between">
                                            <a class="btn btn-sm btn-warning" href="/admission/requirement/<?php echo $uslov->id ?>">Измена</a>
                                            <form action="/admission/requirement/<?php echo $uslov->id; ?>" method="post">
