...
<div class="card p-2">
    <div class="d-flex justify-content-between align-content-center">
        <h2>Wdgets</h2>
        <a class="btn btn-primary d-flex justify-content-center align-items-center" href="/dashboard/widget/create">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-heading-<?php echo $widgetName ?>">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#flush-collapse-<?php echo $widgetName ?>" aria-expanded="false"
                            aria-controls="flush-collapse-<?php echo $widgetName ?>">
                        <?php echo $widgetName; ?>
                    </button>
                </h2>
                <div id="flush-collapse-<?php echo $widgetName ?>" class="accordion-collapse collapse"
                     aria-labelledby="flush-heading-<?php echo $widgetName ?>" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <?php foreach ($widget as $item): ?>
                            <form action="/dashboard/widget/<?php echo $item->id; ?>" method="post" class="row">
                                ...
                                <div class="col-md-6 my-3">
                                    <div class="form-group d-flex flex-column justify-content-between h-100">
                                        ...
                                        <textarea class="form-control flex-grow-1" style="resize: none" name="settings"
                                                  cols="30"><?php echo $item->settings; ?></textarea>
                                    </div>
                                </div>
                            ...
                            <form action="/dashboard/widget/<?php echo $item->id; ?>" method="post">
